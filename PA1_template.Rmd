...
```
The mean of the total number of steps taken per day is `r mean_steps_by_day`.

The median of the total number of steps taken por day is `r median_steps_by_day`.
...
* Mean of the total number of steps taken per day: `r fix_mean_steps_by_day`.
